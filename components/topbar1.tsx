    ...
    <header className="h-16 bg-white px-4 md:px-8 flex items-center justify-between">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <div className="w-9 h-9 rounded-full bg-[#D4AF37] flex items-center justify-center text-white font-semibold">
        ...
        <div className="md:hidden relative" ref={dropdownRef}>
          <button
            ...
            className="w-9 h-9 rounded-full bg-[#D4AF37] flex items-center justify-center text-white font-semibold focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:ring-offset-2"
          >
            {user?.name?.charAt(0).toUpperCase() || 'U'}
          </button>
