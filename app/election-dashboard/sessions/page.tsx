        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          {otherSessionsCount > 0 && (
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-red-50  text-red-600  text-lg font-semibold rounded-xl hover:bg-red-100  transition-colors whitespace-nowrap"
            >
              <ShieldAlert size={18} />
                ...
                >
                  ...
                  {!session.isCurrent && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-2 bg-red-50  text-red-500  text-sm font-medium rounded-lg hover:bg-red-100 transition-colors disabled:opacity-40 shrink-0"
                    >
                      <LogOut size={14} />
                      Log Out
                    </button>
